...
f.bottomzoom::
  ...
  edge of the current monitor, or restores the original size if the window was
...
f.fullscreenzoom::
  ...
  current monitor, so the window decorations are off-screen.  This gives the same
...
f.fullzoom::
  ...
  current monitor, or restores the original size if the window was already
  fullzoom'd.
...
f.horizoom::
  ...
  the current monitor, or restores the original size if the window was already
  horizoom'd.
