...
f.bottomzoom::
  This function stretches the height of the window so that its bottom
  reaches to the bottom of the screen, or restores the original size if
  the window was already bottomzoom'd.
