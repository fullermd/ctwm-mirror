...
MonitorLayout { `monitor-list` }::
  ...
  %%NEXT%%), and the `RANDR` extension is available on your server, then
...
define(LeftGeom,  `AutoL:'LeftWidth`x'HEIGHT`+0+0')
define(RightGeom, `AutoR:'RightWidth`x'HEIGHT`+'LeftWidth`+0')
MonitorLayout
{
    "LeftGeom"
    "RightGeom"
