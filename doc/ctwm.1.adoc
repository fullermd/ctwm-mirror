...
----
+
Only available when ctwm is build with `USE_SOUND`.  See the SOUNDS
section.  Note that if this section is given in the ctwmrc, the
`~/.ctwm-sounds` file will not be parsed.  First appeared in %%NEXT%%.
