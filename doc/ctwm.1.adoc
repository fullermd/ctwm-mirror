...
+
These definitions were added post-3.8.2, so will not exist in earlier
versions.  For comparison, in this situation, TWM_VERSION will be
"3.8.2".
...
EWMH::
  Is defined only if ctwm was compiled with EWMH support.
