...
BackingStore::
  ...
  also `NoBackingStore`.  Added in %%NEXT%%.
...
NoDecorateTransients::
  ...
  also `DecorateTransients`.  Added in %%NEXT%%.
...
NoSortIconManager::
  ...
  order they show up.  See also `SortIconManager`.  Added in %%NEXT%%.
...
RestartPreviousState::
  ...
  workspaces a window should be visible.
...
StartInMapState::
  ...
  in its map form when created.  See also `StartInButtonState`.
